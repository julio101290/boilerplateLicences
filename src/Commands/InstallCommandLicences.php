...
class InstallCommandlicences extends BaseCommand
{
     ...
     * @var string
     */
    protected $group = 'boilerplatelicences';
     ...
     * @var string
     */
    protected $name = 'boilerplatelicences:installlicences';
     ...
     * @var string
     */
    protected $description = 'Db install for basic boilerplate licences data.';
     ...
     * @var string
     */
    protected $usage = 'boilerplatelicences:installlicenes';
    ...
    public function run(array $params)
    {
        try {
            ...
            $seeder->call('julio101290\boilerplatelicences\Database\Seeds\BoilerplateLicences');
        } catch (\Exception $e) {
            $this->showError($e);
        }
    }
